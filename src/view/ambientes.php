        ...
        <div class="card">
            <div class="card-body">
                <div class="page-title-box d-flex align-items-center justify-content-between p-0">
                    <h4 class="mb-0 font-size-18">Ambientes</h4>
                    <div class="page-title-right">
                        <a href="<?php echo BASE_URL; ?>nuevo-ambiente" class="btn btn-primary waves-effect waves-light">+ Nuevo</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="row col-12">
                    ...
                    <div class="form-group row mb-3 col-6">
                        ...
                        <div class="col-7">
                            <input type="text" class="form-control" name="busqueda_tabla_ambiente" id="busqueda_tabla_ambiente">
                        </div>
                    </div>
                </div>
