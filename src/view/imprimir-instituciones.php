...
$contenido_pdf = '
<h2 style="text-align:center; text-transform:uppercase; color:#2c3e50;">REPORTE DE INSTITUCIONES EDUCATIVAS</h2>
...
<table style="width:100%; border-collapse:collapse; margin-top:15px;" border="1" cellpadding="6">
    <thead>
        <tr style="background-color:#eaeaea; color:#2c3e50;">
            ...
            <th style="border:1px solid #ccc; font-size:8px; text-align: center;">CÓDIGO<br>MODULAR</th>
            <th style="border:1px solid #ccc; font-size:8px; text-align: center;">NOMBRE DE LA INSTITUCIÓN</th>
            <th style="border:1px solid #ccc; font-size:8px; text-align: center;">RUC</th>
            <th style="border:1px solid #ccc; font-size:8px; text-align: center;">BENEFICIARIO</th>
        </tr>
    </thead>
    <tbody>';
...
if (isset($respuesta['contenido']) && !empty($respuesta['contenido'])) {
    ...
    foreach ($respuesta['contenido'] as $institucion) {
        ...
        <tr style="background-color:' . ($i % 2 == 0 ? '#f9f9f9' : '#ffffff') . ';">
            ...
            <td style="border:1px solid #ccc; font-size:8px;">' . $institucion['cod_modular'] . '</td>
            <td style="border:1px solid #ccc; font-size:8px;">' . $institucion['nombre'] . '</td>
            <td style="border:1px solid #ccc; font-size:8px;">' . $institucion['ruc'] . '</td>
            <td style="border:1px solid #ccc; font-size:8px;">' . (isset($institucion['usuario']['nombres_apellidos']) ? $institucion['usuario']['nombres_apellidos'] : 'N/A') . '</td>
        </tr>';
        $i++;
    }
} else {
    $contenido_pdf .= '
    <tr>
        <td colspan="5" style="text-align:center; border:1px solid #ccc; font-size:12.5px;">
